...
- An ongoing slew keeps its initial target. Ordinary commands received during settling, including a requested safe mode, are ignored and are not queued. Environment-enforced safe mode immediately aborts the slew. After settling, command the target mode again to start productive work.
